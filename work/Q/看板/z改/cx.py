...
if __name__ == "__main__":
    visual_plus_cat_ids = list(get_collection("main_ml_mx", "ml_mx", "visualize_table").find({}, {"cat_id": 1}))
    ...
    for d in tqdm(visual_plus_cat_ids, desc="Processing categories"):
        cat_id = d["cat_id"]
        with ProcessPoolExecutor(max_workers=12) as executor:
            futures = [executor.submit(process_time, cat_id, t) for t in TIMES_LIST]
